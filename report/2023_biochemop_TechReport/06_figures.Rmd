...
tmpfile <- list.files(paste0(path_netMesozooplankton,"figures/",report_year,"/"), pattern="AZOMPMesozooplanktonCfinPDI", full.names=TRUE)
knitr::include_graphics(tmpfile)
```
...
tmpfile <- list.files(paste0(path_netMesozooplankton,"figures/",report_year,"/"), pattern="AZOMPMesozooplanktonCglacChyper", full.names=TRUE)
knitr::include_graphics(tmpfile)
```
...
tmpfile <- list.files(paste0(path_netMesozooplankton,"figures/",report_year,"/"), pattern="AZOMPMesozooplanktonPseudoOith", full.names=TRUE)
knitr::include_graphics(tmpfile)
```
...
tmpfile <- list.files(paste0(path_netMesozooplankton,"figures/",report_year,"/"), pattern="AZOMPMesozooplanktonEuphAmph", full.names=TRUE)
knitr::include_graphics(tmpfile)
```
