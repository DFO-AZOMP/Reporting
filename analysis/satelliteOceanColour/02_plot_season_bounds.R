...
dat_file <- "analysis/satelliteOceanColour/data/verified_fits_labrador_sea_occci_fall.Rdata" # Rdata file generated by format_bloommetrics script in PhytoFit "tools"
bounds_file <- "analysis/satelliteOceanColour/data/AZOMP_polygon_season_bounds_OCCCI.csv" # columns: Region, spring/summer/fall
...
# dat_file <- "analysis/satelliteOceanColour/data/verified_fits_labrador_sea_modis_fall.Rdata" # Rdata file generated by format_bloommetrics script in PhytoFit "tools"
# bounds_file <- "analysis/satelliteOceanColour/data/AZOMP_polygon_season_bounds_MODIS.csv" # columns: Region, spring/summer/fall
